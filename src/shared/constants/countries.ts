/**
 * Countries Constants
 * Complete list of 195 countries with French names (ISO 3166-1 alpha-2 codes)
...
/**
 * Complete list of 195 countries in alphabetical order (by French name)
...
/**
 * Validate if a value is a valid ISO 3166-1 alpha-2 country code
 */
